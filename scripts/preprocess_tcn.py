...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Preprocess CMAPSS data using the vendored TCN project.")
...
def main() -> None:
    ...
    cmd = [
        sys.executable,
        str(project_root / "tcn_core" / "scripts" / "preprocess_cmapss.py"),
        "--config",
